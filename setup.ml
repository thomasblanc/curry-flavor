...
(* OASIS_START *)
(* DO NOT EDIT (digest: dbdf6875e9f44dbe4fc392b4af510192) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Curryfied nested maps and sets compatible with OCaml's standard\nlibrary maps and sets";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["CurryMap"; "CurrySet"];
                      lib_pack = false;
                      lib_internal_modules = ["CurryMap"; "CurrySet"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "curry-flavor"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "graph.ml"});
               Executable
                 ({
                     cs_name = "translator";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "translator.ml"});
               Executable
                 ({
                     cs_name = "bigset";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "bigset.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\1793c\237P\131\t\206{C\029>{\213\158\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
